...
Mostrar el resultado y el indicador **IA conectada**.
...
## 1:25–1:42 — Respaldo offline

Desconectar internet o abrir la versión local.

“Si la conexión falla, el flujo no se detiene: un clasificador local permite mantener la demostración y orientar la consulta.”
